(function (global, factory) {
    ...
    class EventBus {
        ...
        emit(event, data) {
            var _a;
            (_a = this._listeners.get(event)) === null || _a === void 0 ? void 0 : _a.forEach(cb => {
                try {
                    cb(data);
                }
                catch (e) {
    ...
    class DragResizeHandler {
        constructor(winEl, headerEl, opts = {}) {
            ...
            this._opts = {
                throttleMs: (_a = opts.throttleMs) !== null && _a !== void 0 ? _a : 16,
                resizeBorderPx: (_b = opts.resizeBorderPx) !== null && _b !== void 0 ? _b : 8,
                minWidth: (_c = opts.minWidth) !== null && _c !== void 0 ? _c : 200,
                minHeight: (_d = opts.minHeight) !== null && _d !== void 0 ? _d : 120,
                containerEl: opts.containerEl,
                onDragStart: (_e = opts.onDragStart) !== null && _e !== void 0 ? _e : (() => { }),
                onDrag: (_f = opts.onDrag) !== null && _f !== void 0 ? _f : (() => { }),
                onDragEnd: (_g = opts.onDragEnd) !== null && _g !== void 0 ? _g : (() => { }),
                onResizeStart: (_h = opts.onResizeStart) !== null && _h !== void 0 ? _h : (() => { }),
                onResize: (_j = opts.onResize) !== null && _j !== void 0 ? _j : (() => { }),
                onResizeEnd: (_k = opts.onResizeEnd) !== null && _k !== void 0 ? _k : (() => { }),
            };
...
`;
    ...
    class WindowManager {
        constructor(opts = {}) {
            ...
            this._container = (_a = opts.container) !== null && _a !== void 0 ? _a : document.body;
            this._throttleMs = (_b = opts.throttleMs) !== null && _b !== void 0 ? _b : 16;
            this._isolated = (_c = opts.isolated) !== null && _c !== void 0 ? _c : false;
        ...
        open(config) {
            ...
            const state = {
                id: config.id,
                title: config.title,
                slotType: (_a = config.slotType) !== null && _a !== void 0 ? _a : 'dom',
                content: config.content,
                x: (_b = config.x) !== null && _b !== void 0 ? _b : 60 + offset,
                y: (_c = config.y) !== null && _c !== void 0 ? _c : 60 + offset,
                width: (_d = config.width) !== null && _d !== void 0 ? _d : DEFAULT_WIDTH,
                height: (_e = config.height) !== null && _e !== void 0 ? _e : DEFAULT_HEIGHT,
            ...
            const dragResize = new DragResizeHandler(elements.root, elements.header, {
                ...
                onDrag: (x, y) => {
                    state.x = x;
                    state.y = y;
                    this.events.emit('window:moved', Object.assign({}, state));
                },
                onResize: (x, y, w, h) => {
                    state.x = x;
                    state.y = y;
                    state.width = w;
                    state.height = h;
                    this.events.emit('window:resized', Object.assign({}, state));
                },
            });
            // 綁定標題列按鈕
            ...
            this.events.emit('window:opened', Object.assign({}, state));
            return state;
        }
        /**
         * 關閉並銷毀視窗
        ...
        focus(id) {
            ...
            if (win.state.isMinimized)
                this.restore(id);
            this.events.emit('window:focused', Object.assign({}, win.state));
        }
        /**
         * 最小化（隱藏 DOM，保留狀態）
         */
        minimize(id) {
            ...
            this.events.emit('window:minimized', Object.assign({}, win.state));
            this._focusTopWindow();
        }
        /**
         * 最大化
        ...
        maximize(id) {
            ...
            this.focus(id);
            this.events.emit('window:maximized', Object.assign({}, win.state));
        }
        /**
         * 還原：
        ...
        restore(id) {
            ...
            if (wasMaximized) {
                ...
                win.elements.root.classList.add('wos-maximized');
                this.events.emit('window:restored', Object.assign({}, win.state));
                return;
            }
        ...
        getState(id) {
            const win = this._wins.get(id);
            return win ? Object.assign({}, win.state) : undefined;
        }
        /** 取得視窗 Body DOM 節點，供外部 Wijmo / jQuery 附加內容 */
        getBodyElement(id) {
            var _a;
            return (_a = this._wins.get(id)) === null || _a === void 0 ? void 0 : _a.elements.body;
        }
        /** 取得所有視窗 ID 清單 */
        getWindowIds() {
        ...
        _focusTopWindow() {
            ...
            if (topWin) {
                topWin.state.isActive = false; // reset so focus() triggers
                this.focus(topWin.state.id);
            }
        }
    }
